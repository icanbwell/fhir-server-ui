...
const StructureDefinition = ({ resource }: { resource: TStructureDefinition }): React.ReactElement => {
    ...
    return (
        <>
            ...
            {
                resource.abstract !== undefined && resource.abstract !== null &&
                <Partials.Boolean
            ...
            {
                resource.contextInvariant !== undefined && resource.contextInvariant !== null &&
                <Partials.String
                    string={resource.contextInvariant}
                    name='Context Invariant'
                    resourceType={resource.resourceType}
                    id={uuid}
                    searchParameter='context-invariant'
                />
            }
            {
            ...
            {
                resource.baseDefinition !== undefined && resource.baseDefinition !== null &&
                <Partials.Canonical
            ...
            {
                resource.snapshot !== undefined && resource.snapshot !== null &&
            ...
            {
                resource.differential !== undefined && resource.differential !== null &&
