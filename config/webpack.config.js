...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      // The build folder.
      path: paths.appBuild,
      // Disable pathinfo in development for faster builds.
      // webpack 5 recommends this for large projects.
      pathinfo: false,
    ...
    plugins: [
      ...
      !disableESLintPlugin &&
        new ESLintPlugin({
          ...
          cwd: paths.appPath,
          // Use the eslint.config.js file instead of inline configuration
          overrideConfigFile: path.resolve(paths.appPath, 'eslint.config.js'),
        }),
    ].filter(Boolean),
